...
@router.get("/org", status_code = status.HTTP_200_OK, response_model=list[schemas.OrgOut])
...
@router.get("/org/{org_id}", status_code=status.HTTP_202_ACCEPTED,response_model=schemas.OrgOut)
...
@router.post("/org", status_code=status.HTTP_201_CREATED, response_model=schemas.OrgOut)
